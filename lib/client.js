  ...
  factory: (require) => {
    ...
    function SubagentRulesSelector(props) {
      ...
      const insertBtnStyle = {
        ...
        minHeight: 32,
        color: "#fff",
        background: "var(--dsw-alias-interactive-bg-hover, #4a9eff)",
        border: "none",
        borderRadius: 8,
        padding: "5px 8px",
        fontSize: 13,
        ...
        cursor: "pointer",
        marginTop: 4,
        boxShadow: inserted ? "0 0 0 2px var(--dsw-alias-border-l3)" : "none",
      };
          ...
          react.createElement(
            ...
            step === "effort" &&
              react.createElement(
                ...
                react.createElement(
                  "button",
                  { type: "button", style: insertBtnStyle, onClick: insert },
